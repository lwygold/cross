                ...
                <div className='inner'>     
                    ...
                    <div className='info__body'>
                        <div className='info__body__row flex__lrt'>
                            ...
                            <div>                                
                                <input className='readonly input__text active' value="전문투자자" />                                
                            </div>
                        </div>                                                                                          
                            ...
                            <div>                                                                          
                                <div className='toggle__box'>
                                    <div className='toggle__box__top'>
                                        <input className='readonly input__text border-bottom0' value="전문투자자" />
                                ...
                                <div className='round__box3 flex__lrc'>
                                    <div className='doc'>
                                        ...
                                        <div className='flex__b'>
                                            ...
                                            <img src='./assets/images/sub/change_arr4.svg' />
                                            <p>전문투자자 확인증(금융투자협회 or 증권사)</p>
                                        </div>
                                    </div>
...
export default Account_change3;
