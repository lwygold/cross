...
import Board6 from '@components/Board6/Board6.js';
...
function Account1_1() {    
    ...
    const [activeTab1, setActiveTab1] = useState('신청 중 상품');
                ...
                <div className='inner'>     
                    <div className='account__header'>
                        <ul className='common__tab type1'>
                            ...
                            <li className={ linkName === '/account1_1' ? 'active' : '' }>
                                <Link href="#">
                                    투자내역
                                </Link>
                            </li>
                    ...
                    <div className='com__board deposit__body'>
                        <h5 className='account__title'>신청 중 상품</h5>
